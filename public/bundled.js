...
_reactDom2.default.render(_react2.default.createElement(_IndecisionApp2.default, null), document.getElementById('app')); // npm run serve
// npm run build
...
var Options = function Options(props) {
    return _react2.default.createElement(
        ...
        props.options.map(function (option) {
            return _react2.default.createElement(_Option2.default, { key: option, text: option, handleDeleteOption: props.handleDeleteOption });
        })
    );
};
